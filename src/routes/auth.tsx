...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Dealership Manager" },
      { name: "description", content: "Sign in to your dealership management workspace." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4">
      ...
      <div className="w-full max-w-md">
        <Link to="/" className="flex items-center justify-center gap-2 mb-6 text-foreground">
          ...
          <span className="font-semibold text-lg">Dealership Manager</span>
        </Link>
        <Card>
          <CardHeader>
